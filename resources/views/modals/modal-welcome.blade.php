...
<div class="modal fade" id="modal-welcome" tabindex="-1" role="dialog" aria-labelledby="modalWelcomeLabel" aria-hidden="true">
    {{-- <div id="modal" class="modal"> --}}
      <div class="modal-content">
        ...
        <h3>Join Twitter today</h3>
          ...
          <div class="channel-container login-option modal-login-option">
            <div class="channel-image login-option-image">
              <img  src="https://lh3.googleusercontent.com/a/AGNmyxaRC5TjJaJabXPexoiSRCzKzhtTUQHV645mP7so=s96-c" alt="Zdjęcie profilowe użytkownika Kent">
            </div>
          ...
          <div class="channel-container login-option login-option-apple modal-login-option">
            <div class="channel-image login-option-image">
          ...
          <div class="channel-container login-option login-option-apple modal-login-option">
            <div class="channel-info">
                            <div class="channel-name login-option-wrapper"><button class="btn btn-empty" data-toggle="modal"
                                    data-target="#modal-register">Create an account</button></div>
            </div>
          </div>

          <div class="login-disclamier dimmed-text">
            By signing up, you agree to the <span class="hashtag"> Terms of Use and Privacy Policy</span> , including <span class="hashtag"> the Cookie Policy</span> .
          </div>
