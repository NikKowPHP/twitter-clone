...
if(isset($_GET['join'])) {
    ...
    $modal_body = '
          ...
          <div class="channel-container login-option login-option-apple modal-login-option">
            <div class="channel-info">
              <a class="channel-name" href="#" id="create_account_btn"> Create an account</a>
            </div>
          </div>
    ...
    ';
    $modal_join_obj = new Modal(id: "modal-register", header: $modal_header, body: $modal_body, classes: "modal-join");
    echo $modal_join_obj->render();
}
