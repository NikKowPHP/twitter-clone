...
export default function CreateTweet() {
	return (
        <form action="/tweets/store" method="post"
            ...
            <section className="create-tweet-section">

                <div className="create-tweet-image-text-wrapper">
                    <div className="create-tweet-image-container">
                        <a href="{{'/users/profile/'. $user->id}}"><img src="{{asset('images/'. $user->image)}}" alt=""/></a>
                    </div>
                    <textarea
                            className="create-tweet-text"
                            name="description"
                ...
                <div className="create-tweet-tools-container">
                    ...
                    <div className="create-tweet-submit-container">
                        <button className="btn btn-disabled" id="create-tweet-submit-btn" type="submit">Tweet</button>
                    </div>
                </div>
